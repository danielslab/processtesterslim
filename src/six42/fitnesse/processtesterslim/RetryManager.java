...
public class RetryManager {
  ...
  public RetryManager(String cmd) {
    ...
    long maxRetryCount = paramValues.length < 1 ? 1 : Long
        .parseLong(paramValues[0]);
    long maxTotalTimeMs = paramValues.length < 2 ? 3000 : Long
        .parseLong(paramValues[1]);
  ...
  public boolean shouldTryAgain() {
    ...
    if ((endTimeMs - startTimeMs) >= maxTotalTimeMs)
      return false;
  ...
  public String toString(String context) {
    return "RetryManager " + context + " [allFieldsPassedNoRetry="
        + allFieldsPassedNoRetry + ", maxTotalTimeMs=" + maxTotalTimeMs
        + ", intervallTimeMs=" + intervallTimeMs + ", startTimeMs="
        + startTimeMs + ", retryCount=" + retryCount + ", maxRetryCount="
        + maxRetryCount + ", loopStartTimeMs=" + loopStartTimeMs + "]";
  }
}
